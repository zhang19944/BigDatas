...
public class Android_BatteryRealTimeDataCollectPartReadOnlyData {
    public static class TokenizerMapper extends MapperBase {
        ...
        public void map(long recordNum, Record record, TaskContext context)
                throws IOException {
            String str = record.get("partreadonlydata").toString();
            ...
            if((Integer.parseInt(strs[36]+strs[37], 16))/10.0<=0||(Integer.parseInt(strs[36]+strs[37], 16))/10.0>100||Integer.parseInt(strs[38]+strs[39], 16)>3000||record.get("id").toString().equals("ffffffffffff")||record.get("id").toString().equals("000000000000")){
                return;
            }
...
//	        }
            ...
            one.set(163,record.get("collecttime"));
            one.set(164,record.get("pid").toString());//pid

            one.set(165,record.get("id").toString());//id
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setMapperClass(Android_BatteryRealTimeDataCollectPartReadOnlyData.TokenizerMapper.class);
        job.setReducerClass(Android_BatteryRealTimeDataCollectPartReadOnlyData.SumReducer.class);
